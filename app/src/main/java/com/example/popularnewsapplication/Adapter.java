package com.example.popularnewsapplication;
...
import com.example.popularnewsapplication.models.Article;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        holder.publish_ad.setText(Utils.DateFormat(model.getPublishedAt()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView, OnItemClickListener onItemClickListener) {
            ...
            publish_ad = itemView.findViewById(R.id.publishAt);
